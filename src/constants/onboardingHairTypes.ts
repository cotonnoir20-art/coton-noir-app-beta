 ...
 * Remplace les visuels dans `assets/images/hair-types/` (fichiers 3A.png … 4C.png, Locks.png).
 */
...
export const ONBOARDING_HAIR_TYPES: OnboardingHairType[] = [
  ...
  { code: 'Locks', desc: 'Locks / dreadlocks', curl: '⫶', image: require('../../assets/images/hair-types/Locks.png') },
];
